...
export class CacheCollection<V, rawStructure> extends BaseCollection<string, rawStructure>  {
    client: CacheBot;
    context: string;
    properties: string[] | { includes: (str: string) => boolean; _cacheAll: boolean; };
    transformerClass: any;
    forceSetFilter: any;
    _options: { client: CacheBot; context: string; properties: string[] | { includes: (str: string) => boolean; _cacheAll: boolean; }; transformerClass: any; maxSize?: number | undefined; sweepFilter?: Function | undefined; forceSetFilter?: Function | undefined; };
    ...
    _set(key: string, value: V, options: {forceSet?: boolean, removeProps?: boolean} = {}) {
