...
function createBot(options, providers) {
    ...
    var bot = (0, discordeno_1.createBot)(options);
    if (providers === null || providers === void 0 ? void 0 : providers.gateway) {
        var gateway = providers.gateway.build({ token: options.token, bot: bot });
        bot.gateway = gateway;
    }
    else
